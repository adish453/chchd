...
public class LocationDropDownValue extends DropDownValue {
     ...
     * can refer to Location drop-down values in an object-oriented manner and
     * use ploymorphic queries. Like all drop-downs, it only uses the inherited
     * ID and displayValue columns and has no "extra" functionality.
     */
}
